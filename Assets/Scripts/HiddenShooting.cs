...
public class HiddenShooting: MonoBehaviour {
	...
	void Update() {
		...
		if (shooting) {
			...
			hits = Physics.RaycastAll(transform.position, transform.forward, 2.0F);
